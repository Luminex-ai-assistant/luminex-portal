import { MoreHorizontal, Shield, User, UserCog, Eye } from 'lucide-react';
...
const roleConfig: Record<ProjectMemberRole, { label: string; icon: typeof User; color: 'default' | 'secondary' | 'warning' | 'outline' }> = {
  lead: { label: 'Lead', icon: Shield, color: 'default' },
